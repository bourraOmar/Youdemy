    ...
    <main>
        ...
        <section class="bg-gradient-to-r from-teal-500 to-orange-500 text-white py-24">
            <div class="container mx-auto px-6 text-center">
                <h1 class="text-5xl font-bold mb-4 animate__animated animate__fadeInDown">Create an Account</h1>
                <p class="text-xl mb-8 animate__animated animate__fadeInUp">Join us to start your learning journey.</p>
            </div>
        </section>
            ...
            <div class="max-w-md mx-auto">
                ...
                <form class="mt-8 space-y-6 bg-white p-8 rounded-lg shadow" method="post" action="../Handling/AuthHandl.php">
                    ...
                    <div>
                        ...
                        <input type="password" name="confirm_password" required class="mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                    </div>

                    <button type="submit" name="signupsubmit" class="w-full bg-primary py-2 px-4 border border-transparent rounded-md text-sm font-medium btn-hover focus:outline-none text-white bg-teal-600 hover:bg-teal-700">
                        Sign Up
                    </button>

                    <div class="text-center text-sm text-gray-600">
                        Already have an account?
                        <a href="../pages/login.php" class="font-medium text-orange-600 hover:text-orange-500">Log in</a>
                    </div>
                </form>
            </div>
        </section>
